...
?>
    ...
    ?>
            ...
            <body>
                        ...
                        <div class="col-sm-9 col-sm-offset-3 no-float">
                            <div class="container-fluid" style="padding: 0;">
                                <div class="details" id="details">
                                    ...
                                    <a href="login.php"><button class="btn btn-primary savebtn" name="saveWishlist" id="saveWishlist" style="float:right;">ADD TO WISHLIST</button></a>
                                ...
                                <div class="card tbig">
                                    <div class="card-body">
                                        ...
                                        <div class="review">
                                            ...
                                            ?>
                                            <br>
                                            <span class="card-text moree"><?php echo nl2br($row['admin_review']); ?></span><a class="readmoree">... read more</a>
                                        </div>
                                        <br>
                                        <span style="float:right;font-size:13px;color:#AAAAAA">Last updated: <?php echo $time_elapsed; ?></span>
                                    </div>
                            ...
                            <div class="container-fluid" style="padding: 0;">
                                <div class="card tbig">
                                    <div class="card-body">
                                        ...
                                        <a href="login.php"><button class="btn-tertiary addCart" id="cart_save" name="cart_save">ADD TO CART</button></a>
                                    </div>
                                    <div class="card-footer" style="height:70px"></div>
                                </div>
                            ...
                            <div class="container-fluid" style="padding: 0;">
                                <div class="card tbig">
                                    <div class="card-body" style="padding-right: 20px;">
                                                    ...
                                                    <tr>
                                                        <table>
                                                            ...
                                                            <td width=100%><span style="font-weight:600;color:#BF95FC;"><a href="dynamicProfile.php?ID=<?php echo $coms['username'] ?>"><?php echo $coms['username']; ?></span></a>&nbsp&nbsp&nbsp<span style="color:#AAAAAA;font-size:12px"><?php echo $commentAgo ?></span>
                                                                ...
                                                                <div id="reply<?php echo "$i" ?>" class="form-group collapse">
                                                                    <textarea name="reply" id="replyy" class="form-control" rows="2" placeholder="Reply" maxlength="500" required></textarea>
                                                                    <a href="login.php"><button name="Reply" id="Reply" style="float:right; margin-top: 5px;margin-bottom: 10px;" class="btn btn-primary replybtn">Reply</button></a>
                                                                </div>
                                                            </td>
                                                        </table>
                                                    </tr>
                                        ...
                                        <a href="login.php"><button name="Comment" id="Comment" style="float:right" class="btn btn-primary commentbtn">Comment</button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <script type="text/javascript">
                    const moree = document.querySelector('.moree');
                    const textt = moree.innerText;
                    moree.innerText = textt.substring(0, 250);
                    let showAlll = false;
                    const buttonn = document.querySelector('.readmoree');
                    buttonn.addEventListener('click', () => {
                        showAlll = !showAlll;
                        moree.innerText = showAlll ? textt : textt.substring(0, 250);
                        buttonn.innerText = showAlll ? ' read less' : '... read more';
                    });
                </script>
