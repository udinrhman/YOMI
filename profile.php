                    ...
                    <div class="card profile" style="border-bottom: none">
                        <div class="card-body" style="padding-left:0px;padding-right:0px;padding-top:0px;padding-bottom:0px;">
                            <div class="twPc-div">
                                ...
                                <div class="User">
                                    <div class="name">
                                        <?php echo $row1['user_fullname'] ?><a href="editProfile.php"><button class="btn btn-primary editProfile">EDIT PROFILE</button></a>
                                    </div>
                                    <span class="username">@<?php echo $row1['username'] ?></span>
                                </div><br>
                                <span class="email"><i class="far fa-envelope"></i> <?php echo $row1['user_email'] ?></span>
                                <div class="stats">
                                    <?php
                                    $query3 = "SELECT * FROM wishlist WHERE username = '" . $_SESSION["username"] . "'";
                                    ...
                                    <div class="twPc-ArrangeSizeFit">
                                        <span class="value"><?php echo $row1['yomi_tokens']; ?></span>&nbsp<a href="profile.php#img">YOMI TOKENS</a>
                                    </div>
                                    <div class="twPc-ArrangeSizeFit">
                                        <span class="value"><?php echo $countWishlist; ?></span>&nbsp<a href="wishlist.php">WISHLIST</a>
                                    </div>
                                </div>
                            </div>
                        </div>
